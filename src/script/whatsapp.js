...
//w.href = `https://w.app/5Yb1fv?widget`;
w.href = `https://api.whatsapp.com/send?phone=+5493434510491&text=%2AHola+Rotiser%C3%ADa+Do%C3%B1a+Lita%2A+%F0%9F%98%83%0A%0ATe+escribo+desde+la+web%2C+quisiera+realizar+un+pedido+%F0%9F%A4%A9%0A%0APodes+contactarte+conmigo+a+este+n%C3%BAmero.`;
w.target = '_blank';
